...
var (
	MySQL = initMySQLConfig("userservice/configs/mysql.yaml")
	Jwt   = initJwtConfig("userservice/configs/jwt.yaml")
	Redis = initRedisConfig("userservice/configs/redis.yaml")
)
